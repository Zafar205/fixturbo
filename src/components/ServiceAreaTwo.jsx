    ...
    <div className="service-area-2 space overflow-hidden">
      ...
      <div className="container-fluid">
        <div className="vehicle-categories-container">
          <div className="vehicle-categories-scroll">
            {/* Duplicate the array for infinite scroll effect */}            {[...vehicleCategories, ...vehicleCategories].map((category, index) => (
              <div 
                key={index} 
      ...
      <style jsx>{`
        ...
        .vehicle-categories-scroll:hover {
